...
class Minifycss {
     ...
     * @var string
     */
    protected static $className = 'Minifycss';
     ...
     * @return string
     */
    public static function _selectorsCB($m)
    {
     ...
     * @return string   
     */
    public static function _commentCB($m)
    {
        $m = $m[1]; 
    ...
    public static function _urlCB($m)
    {
     ...
     * @return string   
     */
    public static function _fontFamilyCB($m)
    {
        $m[1] = preg_replace('/
                \\s*
                (
